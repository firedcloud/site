...
var kitty = {};
kitty.fs = cljs.nodejs.require.call(null, "fs");
kitty.kitties = function() {
  return kitty.fs.readFileSync(cljs.core.str.call(null, "art/kitties.txt"), "ascii").split("\n\n")
};
kitty.random_kitty = function() {
  return clojure.string.trim.call(null, cljs.core.rand_nth.call(null, kitty.kitties.call(null)))
};
kitty._main = function() {
  return cljs.core.println.call(null, kitty.random_kitty.call(null))
};
cljs.core._STAR_main_cli_fn_STAR_ = kitty._main;
cljs.nodejscli = {};
